...
- **`src/components/`**: UI building blocks.
  ...
  - **Section Controllers**: `MainContent.jsx` (Code), `TransparencyContent.jsx` (Transparency publications and resource mapping), `TreeContent.jsx` (Trees with `TreeLandingPage.jsx` filter search), `QuizContent.jsx` (Quiz), `TPPTContent.tsx` (TPPT Checker) and `EventSupportContent.jsx` (the “Can I support this event?” checker, lazy-loaded) act as sub-routers and layout managers for their respective features.
