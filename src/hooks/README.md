...
`useCvsLookup.js` runs the event support checker's live CVS search and status lookup; `useCheckerText.js` links glossary terms and Code references in the checker's wording.
